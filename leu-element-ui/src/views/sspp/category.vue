            ...
            <el-row v-for="item2 in item" :key="item2.$index">
              ...
              <el-row v-for="item3 in item2.child" :key="item3.$index">
                ...
                <template v-for="item4 in item3.child">
                  ...
                  <el-button v-for="item5 in item4.child" :key="item5.$index" type="warning" plain @click="openGoods(key,item5.cid, item2.zh_name+'>'+item3.zh_name+'>'+item4.zh_name+'>'+item5.zh_name)">{{ item5.name }}</el-button>
                </template>
              </el-row>
              <hr>
            </el-row>
